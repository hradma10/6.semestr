...
\begin{document}
	...
	\begin{enumerate}[label=\arabic*.]
		...
		\item Relace, binární relace a jejich reprezentace, operace s relacemi
		\item Funkce (zobrazení) a jejich vlastnosti \checkmark
		\item Binární relace na množině a jejich vlastnosti
		...
		\item Orientované a neorientované grafy, základní pojmy
		\item Hledání nejkratší cesty, Dijkstrův algoritmus
		\item Minimální kostra grafu, Kruskalův algoritmus
		\item Stromy, kořenové stromy, vztahy mezi výškou, počtem vrcholů a počtem listů
	\end{enumerate}
	
	Postup DISK1: 3/16 18.75\%
	...
	\newline
	\newline
	Postup Teoretické Základy informačních technologií: 7/45 15.55\%
	...
	\newline
	\newline
	Postup Státnicové okruhy: 9/133 6.76\%
