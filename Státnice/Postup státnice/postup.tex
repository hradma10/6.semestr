...
\begin{document}
	...
	\begin{enumerate}[label=\arabic*.]
		...
		\item Implementace stránkování na i386, AMD64
	...
	Postup OS2: 10/11 90.9\%
	
	\subsection*{DATAB}
	
	\begin{enumerate}[label=\arabic*.]
		\item Tabulky v SQL a jejich vztah k relacím
	...
	\begin{enumerate}[label=\arabic*.]
		...
		\item Hardware osobního počítače: základní deska a chipset 
		\item Hardware osobního počítače: procesor a instrukce \checkmark
		\item Hardware osobního počítače: vnitřní a vnější paměti
		\item Hardware osobního počítače: ostatní zařízení
	\end{enumerate}
	
	Postup STRUP: 6/12 50\%
	...
	\begin{enumerate}[label=\arabic*.]
		...
		\item Layout webové stránky: grid
		\item Layout webové stránky: flexbox
		\item Layout webové stránky: pozicování 
	...
	\newline
	\newline
	Postup Informační technologie: 47/85 55.29\%
	...
	\newline
	\newline
	Postup Státnicové okruhy: 80/165 48.48\%
